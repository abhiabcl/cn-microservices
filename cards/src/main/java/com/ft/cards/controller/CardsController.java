package com.ft.cards.controller;
...
import com.ft.cards.dto.ResponseDto;
...
@Tag(name = "Card REST API",
        description = "CURD REST API in esybank to CRETATE, UPDATE, FETCH And DELETE card details!"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            summary = "Fetch API",
            description = "REST API to fetch the card details."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Update API",
            description = "REST API to update the card details."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
